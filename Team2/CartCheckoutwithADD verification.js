...
async function checkoutWithAddressValidation(userId, address, items) {
    try {
        // Validate the address before proceeding
        const addressValidationResponse = await verifyAddress(address);
